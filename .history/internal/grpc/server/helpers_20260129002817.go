...
// - verificationCode: code for verification (not validated in this helper, caller must handle)
// - userID: ID of the user to update
// - messageOnSuccess: message to return on success
//
// Returns:
// - success flag, message, user data, and any error
