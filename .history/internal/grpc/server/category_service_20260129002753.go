...
func (s *CategoryServiceServer) DeleteCategoryAttribute(ctx context.Context, req *pb.DeleteCategoryAttributeRequest) (*pb.Empty, error) {
	return DeleteEntity(ctx, s.db, "category_attributes", req.GetId(), "attribute")
}
...
func (s *CategoryServiceServer) getAttributeByID(ctx context.Context, id string) (*pb.CategoryAttribute, error) {
	...
	var categoryID, key, attrType string
	...
	attr := s.buildAttribute(id, categoryID, key, attrType, labelJSON, optionsJSON, isRequired, sortOrder, createdAt, updatedAt)
	return attr, nil
}
